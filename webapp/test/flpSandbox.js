		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zvksdatabinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zvksdatabinding-display": {
								"semanticObject": "zvksdatabinding",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zvks.data.binding",
									"url": sap.ui.require.toUrl("zvks/data/binding")
								}
							}
						}
					}
